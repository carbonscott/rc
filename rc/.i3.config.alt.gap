...
font pango:monospace, FontAwesome, Ionicons 9
...
# suspend 
bindsym $mod+Shift+c exec ~/.vim/rc/i3lock_blur.sh
bindsym $mod+Shift+x exec ~/.vim/rc/i3lock_blur_suspend.sh 

# trackpad not working
# ◆ https://www.reddit.com/r/i3wm/comments/516e8c/tap_to_click_touchpad/
# steps
# ○ `xinput list` and find the id according to the item indicating trackpad...
# ○ `xinput list-props <device id>`
# ○ find the property id according to keywords like "Tapping"
# ○ `xinput set-prop <device id> <property id> <value>`
# the following command is to enable the trackpad when I launch my laptop...
exec xinput set-prop 12 274 1
...
# Screenshot
bindsym $mod+Shift+4 exec gnome-screenshot -i
