...
function! dragvisual#DVB_Drag (dir)
...
function! dragvisual#DVB_Duplicate ()
    exec "nnoremap <silent><expr><buffer>  M  \<SID>DuplicateBlock()"
    return '"vyM'
endfunction

function! dragvisual#DuplicateBlock ()
    nunmap <buffer>  M
...
function! dragvisual#Drag_Lines (dir)
...
function! dragvisual#Drag_Block (dir)
    " Clean up the temporary convenience...
    nunmap <buffer>  M
